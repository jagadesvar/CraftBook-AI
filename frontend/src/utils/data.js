...
export const FEATURES = [
  {
    ...
    description:
      "Overcome writer's block with our smart assistance that helps you generate ideas, outlines, and context.",
    icon: Lightbulb,
  ...
  },
  {
    ...
    description:
      "Organize all your ebooks projects in a personal dashboard. Easily track progress, edit drafts, and manage library.",
    icon: Library,
...
export const TESTIMONIALS = [
  {
    quote:
      "This platform made it so easy to write and publish my first ebook. The AI assistance is a game-changer!",
    author: "Jane Doe",
