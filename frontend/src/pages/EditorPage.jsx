...
const EditorPage = () => {
  ...
  const handleGenerateChapterContent = async (index) => {
    ...
    if (!chapter || !chapter.title) {
      toast.error("Chapter title is required to generated content.");
      return;
    }
    ...
    <>
      <div className="flex bg-slate-50 font-sans relative min-h-screen">
        ...
        <main className="flex-1 h-full flex flex-col">
          <header className="sticky top-0 z-10 bg-white/80 backdrop-blur-sm border-b border-slate-200 p-4 flex justify-between items-center">
